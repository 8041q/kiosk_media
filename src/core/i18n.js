...
export const UI_STRINGS = {
  en: {
    ...
    profileRecommendedHelp:'Good visual quality with reasonable file sizes (H.264 CRF 20, AAC 192 kbps).',
    profileHighHelp:'Higher visual quality with larger files (H.264 CRF 17, AAC 256 kbps).',
  ...
  pt: {
    ...
    profileRecommendedHelp:'Boa qualidade visual com tamanho de arquivo razoável (H.264 CRF 20, AAC 192 kbps).',
    profileHighHelp:'Maior qualidade visual com arquivos maiores (H.264 CRF 17, AAC 256 kbps).',
  ...
  es: {
    ...
    profileRecommendedHelp:'Buena calidad visual con tamaños razonables (H.264 CRF 20, AAC 192 kbps).',
    profileHighHelp:'Mayor calidad visual con archivos más grandes (H.264 CRF 17, AAC 256 kbps).',
  ...
  fr: {
    ...
    profileRecommendedHelp:'Bonne qualité visuelle avec des fichiers de taille raisonnable (H.264 CRF 20, AAC 192 kbps).',
    profileHighHelp:'Qualité visuelle supérieure avec des fichiers plus volumineux (H.264 CRF 17, AAC 256 kbps).',
  ...
  zh: {
    ...
    profileRecommendedHelp:'良好画质与合理文件大小（H.264 CRF 20，AAC 192 kbps）。',
    profileHighHelp:'更高画质和更大文件（H.264 CRF 17，AAC 256 kbps）。',
