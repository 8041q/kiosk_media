...
export const UI_STRINGS = {
  en: {
    ...
    scan:'Scan', fixComplete:'Fixed {fixed} videos, {errors} errors', fixFailed:'Fix failed',
  ...
  pt: {
    ...
    scan:'Escanear', fixComplete:'Corrigidos {fixed} vídeos, {errors} erros', fixFailed:'Falha na correção',
  ...
  es: {
    ...
    scan:'Escanear', fixComplete:'Corregidos {fixed} videos, {errors} errores', fixFailed:'Falló la corrección',
  ...
  fr: {
    ...
    scan:'Scanner', fixComplete:'{fixed} vidéos corrigées, {errors} erreurs', fixFailed:'Échec de la correction',
  ...
  zh: {
    ...
    scan:'扫描', fixComplete:'已修复 {fixed} 个视频, {errors} 个错误', fixFailed:'修复失败',
